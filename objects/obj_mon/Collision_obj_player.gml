if (other.speed > obj_mon_spawner.unhandlable_pure_speed) { count_for_combo(other, 1); instance_destroy(); return; }
if (my_color == c_green) { count_for_combo(other, 1); instance_destroy(); return; }
...
if (!instance_exists(purplayer_my_purpellet)) { count_for_combo(other, 1); instance_destroy(); return; }
if (other.my_color == c_purple) { orngplayer_tension++; orngplayer_tension = min(orngplayer_tension, orngplayer_tension_max); }

if (other.my_color == c_white && my_color == c_red) { count_for_combo(other, 1); instance_destroy(); return; }
