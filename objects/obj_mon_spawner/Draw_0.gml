...
if (obj_control.game_started) {
	...
	if (time_between_spawns_now <= 0) {
		time_between_spawns_now = /*sec/10 / / */time_between_spawns_max - (time_between_spawns_max-time_between_spawns_min)*clamp(time_counter/time_between_spawns_width, 0, 1);
